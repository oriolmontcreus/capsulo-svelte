...
export const selectTestsSchema = createSchema<FieldDefinition>({
	name: "Select Tests",
	key: "select-tests",
	description: "Comprehensive test capsule for all Select field configurations.",
	fields: [
		...
		Select("plan")
			...
			.options([
				...
				{ label: "Enterprise", value: "enterprise", description: "Custom solutions for teams", disabled: true },
				{ label: "Legacy", value: "legacy", description: "Deprecated plan", disabled: true },
			]),
		...
		Select("deployment")
			...
			.options([
				{ label: "North America", value: "na", description: "US East & West Coast" },
				{ label: "Europe", value: "eu", description: "Frankfurt & London" },
				{ label: "Asia Pacific", value: "ap", description: "Tokyo & Singapore" },
